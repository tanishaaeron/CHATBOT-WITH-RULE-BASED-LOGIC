...
def chatbot(user_input):
   ...
   if "hi" in user_input or "hello" in user_input:
      ...
      return"I'm just a chatbot , so i dont't have a name , but you can call me anything."
      ...
      return "I dont't eat , but I can help you find delicious recipes and food-realted information."
   elif "favourite colour" in user_input:
      return"I'm a chatbot , so I dont't have personal preferences for colors."
